...
<body>
	<div class="container">
		...
		<div>
			...
			<a class="btn btn-light" href="${cadastro}">Novo Usuário</a>
		</div>
		<hr>
	<div>
		...
		<div class="card">
			...
			<div
				class="card-header alert ${message == null ? '' : 'alert-success'}">
				...
				<tbody>
					<c:forEach var="usuario" items="${usuarios }">
						<tr>
							...
							<td><f:parseDate var="date" value="${usuario.data }"
							...
							<td><spring:url value="/usuario/update/${usuario.id}"
									var="update"></spring:url> <spring:url
									value="/usuario/delete/${usuario.id}" var="delete"></spring:url>

								<a class="btn btn-info" href="${update}">Editar</a> <a
